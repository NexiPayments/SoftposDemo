# Demo Softpos Backend Cloud-Auth
...
In the `application.properties` file, you can configure the port and the application name. By default, it is set to `http://localhost:8081/softpos-backend-cloud-auth/`.
